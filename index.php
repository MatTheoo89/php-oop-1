...
$Movie_1 = new Movie('Batman Begins','Azione', '2h 20m', new Actors('Christian Bale', 'Batman'));
$Movie_1->setPoster('https://pad.mymovies.it/filmclub/2004/08/003/locandina.jpg');

$Movie_2 = new Movie('Il cavaliere oscuro','Azione', '2h 32m', new Actors('Christian Bale', 'Batman'));
$Movie_2->setPoster('https://pad.mymovies.it/filmclub/2007/02/131/locandina.jpg');

$Movie_3 = new Movie('Il cavaliere oscuro - Il ritorno','Azione', '2h 45m', new Actors('Christian Bale', 'Batman'));
